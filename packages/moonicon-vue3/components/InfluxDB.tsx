...
const InfluxDB = defineComponent({
  ...
  render() {
    ...
    return h(
      <defs>
        <g id="InfluxDB">
          <path d="M9.86004 3.07352L18.6303 5.69163L20.7481 14.596L14.0956 20.8822L5.32534 18.2641L3.20754 9.35976L9.86004 3.07352Z" stroke={$props.stroke} strokeWidth={$props.strokeWidth} stroke-linejoin="round"/>
