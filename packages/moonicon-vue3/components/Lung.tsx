...
<path d="M11.0424 4.57306V12.0661C11.0242 13.0209 10.5536 13.4516 8.97827 13.4516" stroke={$props.stroke} strokeWidth={$props.strokeWidth} stroke-linecap="round"/>
<path d="M13 4.57V12.0631C13.0182 13.0179 13.4888 13.4486 15.0641 13.4486" stroke={$props.stroke} strokeWidth={$props.strokeWidth} stroke-linecap="round"/>
