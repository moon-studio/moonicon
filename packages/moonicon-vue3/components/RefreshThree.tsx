...
const RefreshThree = defineComponent({
  ...
  render() {
    ...
    return h(
      <defs>
        <g id="RefreshThree">
          <path d="M4 4.5V9.5H9" stroke={$props.stroke} strokeWidth={$props.strokeWidth} stroke-linecap="round" stroke-linejoin="round"/>
<path d="M20 19.5V14.5H15" stroke={$props.stroke} strokeWidth={$props.strokeWidth} stroke-linecap="round" stroke-linejoin="round"/>
