...
const Sleet = defineComponent({
  ...
  render() {
    ...
    return h(
      <defs>
        <g id="Sleet">
          <path d="M10.9836 13L8.78361 19" stroke={$props.stroke} strokeWidth={$props.strokeWidth} stroke-linecap="round"/>
...
<path d="M12.5001 16.996L14.9579 15.5771M14.9579 16.996L12.5002 15.5771M13.7291 14.8676L13.7291 17.7055" stroke={$props.stroke} strokeWidth={$props.strokeWidth} stroke-linecap="round"/>
